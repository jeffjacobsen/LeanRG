...
## Rules
- JSON Format Rule: You MUST respond ONLY with valid JSON in the exact format shown above. Do not include any explanatory text, conversational responses, or other content outside the JSON structure.
...
- Response Rule: Your response must start with a left brace and end with a right brace. Nothing else is allowed.
